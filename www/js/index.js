...
var password = {
    ...
    querySuccess: function(tx, results) {
        ...
        for (var i=0; i<len; i++) {
        	...
        	html+= '<a href="javascript: deleteItem(\'' + row + '\',\'' +  results.rows.item(i).alias  + '\',\'' +  escape(results.rows.item(i).password)  +  '\');" class="delete">Delete</a>';
...
var app = {
    ...
    bindEvents: function() {
		...
		$("#btnCamera").on("tap", password.getPicture);
